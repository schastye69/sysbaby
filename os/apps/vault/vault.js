...
(function () {
  ...
  var UI = {
    en: {
      ...
      keyWarn: "Losing the file is the same as forgetting the word: there is no way back. Save it somewhere that is not this computer before you continue.",
    ...
    ru: {
      ...
      keyWarn: "Потерять файл — то же самое, что забыть слово: обратной дороги нет. Сохраните его туда, что не является этим компьютером, прежде чем продолжить.",
    ...
    ee: {
      ...
      keyWarn: "Faili kaotamine on sama mis sõna unustamine: tagasiteed ei ole. Salvesta see enne jätkamist kuhugi, mis ei ole see arvuti.",
