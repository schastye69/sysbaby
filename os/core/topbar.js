...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "why.messenger": "Without a server there is nobody to talk to: the other party here is drawn, and the window says so itself. A live person on the other end is measured by nothing.",
    ...
    ru: {
      ...
      "why.messenger": "Разговор без сервера не с кем вести: собеседник здесь нарисован, и это сказано внутри самого окна. Живого человека на том конце машина не измеряет ничем.",
    ...
    ee: {
      ...
      "lock.duressWhat": "Teine sõna avab teise, tervikliku süsteemi: oma töölaua, oma märkmed. Miski ei ütle, kas see sõna on olemas — ei silt, ei viivitus, ei ükski rida kettal. Just see vaikus ongi ainus põhjus, miks see toimib.",
      ...
      "why.messenger": "Ilma serverita pole kellegagi rääkida: vestluskaaslane on siin joonistatud, ja aken ütleb seda ise. Elavat inimest teises otsas ei mõõda miski.",
