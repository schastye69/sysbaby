...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "off.не делает работу": "cannot do its work", "off.открывается вещью": "opens from a thing",
    ...
    ru: {
      ...
      "off.не делает работу": "не делает работу", "off.открывается вещью": "открывается вещью",
    ...
    ee: {
      ...
      "off.не делает работу": "ei tee oma tööd", "off.открывается вещью": "avaneb asjast",
