...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "off.не делает работу": "cannot do its work", "off.открывается вещью": "opens from a thing", "off.открывается подарком": "opens as a gift", "why.solitaire": "A gift, not a tool: the chest opens this room, and until it is given the desk is no poorer without it.",
      ...
      "nt.hand": "Hand to…",
      "nt.hand.done": "Handed to {room}",
      "nt.hand.doneSub": "The note is there now. This one stays here too.",
      "nt.hand.fail": "Not handed over",
      "nt.hand.failSub": "That room did not take it, and nothing pretends it did.",
    ...
    ru: {
      ...
      "off.не делает работу": "не делает работу", "off.открывается вещью": "открывается вещью", "off.открывается подарком": "открывается подарком", "why.solitaire": "Подарок, а не инструмент: эту комнату открывает Сундук, и пока она не подарена, стол без неё не беднее.",
      ...
      "nt.hand": "Передать в…",
      "nt.hand.done": "Передано: {room}",
      "nt.hand.doneSub": "Запись теперь и там. Здесь она тоже остаётся.",
      "nt.hand.fail": "Не передано",
      "nt.hand.failSub": "Та комната вещь не взяла, и никто не делает вид, что взяла.",
    ...
    ee: {
      ...
      "off.не делает работу": "ei tee oma tööd", "off.открывается вещью": "avaneb asjast", "off.открывается подарком": "avaneb kingitusena", "why.solitaire": "Kingitus, mitte tööriist: selle toa avab Laegas, ja kuni seda pole kingitud, pole laud ilma selleta vaesem.",
      ...
      "nt.hand": "Anna üle…",
      "nt.hand.done": "Antud üle: {room}",
      "nt.hand.doneSub": "Märge on nüüd ka seal. Siia see samuti jääb.",
      "nt.hand.fail": "Ei antud üle",
      "nt.hand.failSub": "See tuba ei võtnud seda vastu, ja keegi ei teeskle vastupidist.",
