...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      "set.desktop.autohide": "Auto-Hide",
      "set.desktop.autohideSub": "Tuck the dock away until you move the pointer to the bottom edge",
    ...
    ru: {
      ...
      "set.desktop.autohide": "Автоскрытие",
      "set.desktop.autohideSub": "Прячет док, пока вы не подведёте курсор к нижнему краю",
    ...
    ee: {
      ...
      "set.desktop.autohide": "Automaatne peitmine",
      "set.desktop.autohideSub": "Peidab doki ära, kuni viite kursori alumise servani",
