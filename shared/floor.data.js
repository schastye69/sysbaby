...
window.SB_FLOOR = {
  ...
  "places": [
    ...
    },
    {
      ...
      "rooms": ["chest"],
      "where": "os/apps/chest/chest.js:39"
    },
    {
      "id": "sysbaby.keys.v1",
      "kind": "вещи",
    ...
    {
      "id": "sysbaby.lock.idleMin",
      "kind": "выбор",
      "what": "Через сколько минут покоя открытый сеанс закрывается сам; ноль — никогда (D-254).",
      "rooms": ["ядро"],
      "where": "os/core/panels.js:864"
    },
    {
      "id": "sysbaby.lock.spareAt",
      "kind": "служебное",
      "what": "Когда заведён код восстановления замка — только дата, сам код не хранится нигде; лежит под замком (D-266).",
      "rooms": ["ядро"],
      "where": "os/core/store.js:1519"
    },
    {
      "id": "sysbaby.activeProfile",
      "kind": "служебное",
      "what": "Какой из профилей этого браузера открыт сейчас — номер двери, а не сведения о человеке; открыт и при замке, иначе не найти замок.",
      "rooms": ["ядро"],
      "where": "os/core/store.js:165"
    },
    {
      "id": "sysbaby.incognito.timerPref",
      "kind": "выбор",
      "what": "Сколько минут живёт сеанс инкогнито, если его не закрыть раньше, — выбранное вами в последний раз.",
      "rooms": ["ядро"],
      "where": "os/core/panels.js:780"
    },
    {
      "id": "sysbaby.incognito.timerSec",
      "kind": "служебное",
      "what": "Остаток времени текущего сеанса инкогнито; живёт только в этой вкладке и умирает вместе с ней.",
      "rooms": ["ядро"],
      "where": "os/core/panels.js:812"
    },
    {
    ...
    },
    {
      "id": "sysbaby.baton.v1",
      "kind": "вещи",
      "what": "Где вы остановились: какие комнаты были открыты и место в каждой — указателем, без копии текста (D-286, D-289).",
      "rooms": ["ядро"],
      "where": "os/core/baton.js:35"
    },
    {
      "id": "sysbaby.baton.counts",
      "kind": "служебное",
      "what": "Сколько раз вы продолжили, отпустили и отложили эстафету — мера самой эстафеты, видна в Приватности.",
      "rooms": ["ядро"],
      "where": "os/core/baton.js:40"
    },
    {
      "id": "sysbaby.baton.why",
      "kind": "вещи",
      "what": "«Зачем» — одна строка вашими словами к делу, на котором вы остановились (D-290).",
      "rooms": ["ядро"],
      "where": "os/core/baton.js:47"
    },
    {
      "id": "sysbaby.witness.v1",
      "kind": "служебное",
      "what": "Итог прошлого входа по учёту браузера: сколько запросов к себе, к каким дверям описи, сколько страниц открыли вы (без адресов), что ушло вне описи, сколько запечатано (D-291).",
      "rooms": ["ядро"],
      "where": "os/core/witness.js:33"
    },
    {
      "id": "sysbaby.friction.v1",
      "kind": "служебное",
      "what": "Журнал трения, если вы его включили: на комнату три числа — сколько раз открыли, сколько закрыли сразу, когда открыли последний раз — и ваши ответы на предложения. Ничего о содержимом (D-294).",
      "rooms": ["ядро"],
      "where": "os/core/friction.js:30"
    },
    {
