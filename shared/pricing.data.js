 ...
 *
 * TIERS BELOW ARE GENERATED from the "pricing" block of the landing content
 * spec (landing-content.json) by tools/landing-build-data.js.
...
(function (root) {
  ...
  function fmtAmount(lang, v) {
    ...
    /* Финский: сумма как в эстонском, но тысячи разделяются неразрывным
       пробелом — «1 400 €». Финская типографская норма, не догадка. */
    if (lang === "fi") return groupDigits(v, "\u00A0") + " \u20AC";
