  ...
  if (typeof window.registerApp === "function") {
    window.registerApp("browser", {
      /* ── ВРЕМЕННО УБРАНО СО СТОЛА · решение D-186 ──────────────────────
         ...
         ПРИЧИНА ИМЕННО ЗДЕСЬ: Страница внутри страницы: большинство сайтов запрещают себя показывать так, а остальным нужна сеть — то самое, без чего система нарочно умеет жить.
